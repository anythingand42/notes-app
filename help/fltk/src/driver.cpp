...
int main(int argc, char **argv) 
  ...
  int x = sp;
  buttons->begin();
    quit   = new Fl_Button(        x, h-sp-bh, bw, bh, "Quit");   x += bw;
    png    = new Fl_Button(        x, h-sp-bh, bw, bh, "To png"); x += bw;
    svg    = new Fl_Button(        x, h-sp-bh, bw, bh, "To svg"); x += bw;
    eps    = new Fl_Button(        x, h-sp-bh, bw, bh, "To eps"); x += bw;
    pdf    = new Fl_Button(        x, h-sp-bh, bw, bh, "To pdf"); x += bw;
